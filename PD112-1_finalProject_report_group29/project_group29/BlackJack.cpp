...
Record::Record(string playerName)
{
    ...
    this->filePath = "./sources/recordFiles/" + playerName + ".txt";
...
Game::Game()
{
    ...
    this->showPlayersNameAndChr(); // 確認玩家資訊
...
{
    // 讀取txt檔
    ifstream intro("./sources/introFiles/" + file + ".txt");
    if (intro)
    {
...
void Game::addItem(Player *&player)
{
    ...
    << "1: Random Switch, 2: Draw and Fold, 3: Both Fold One" << endl;
    this->printIntro("items");
